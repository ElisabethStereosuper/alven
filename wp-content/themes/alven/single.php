            ...
            <div class='post-wrapper'>
                <article class='wysiwyg post-content'>
                    ...
                    <?php if(get_field('medium')){ ?>
                        <p class='post-medium'><a href='<?php the_field('medium'); ?>' target='_blank'><?php _e('Comment on Medium', 'alven') ?></a></p>
                    <?php } ?>

                    <div class='secondary'>
                        <span class='title-small'><?php _e('Share', 'alven'); ?></span>
                        <ul class='share'>
                            <li>
                ...
                <?php $relatedPosts = alven_related_posts($post->ID); if($relatedPosts){ ?>
                    <aside class='post-sidebar'>
                        <span class='title-small'><?php _e('Related articles', 'alven'); ?></span>
                        <ul>
