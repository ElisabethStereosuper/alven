                ...
                <aside class='portfolio-filters' id='portfolio-filters'>
                     <form role='search' method='get' action='#' class='form-search' id='form-startup'>
                        <div class='field-search js-field'>
                            ...
                            <label class="label" for='search'><?php _e('search', 'alven'); ?></label>
                        </div>
                    ...
                    <button type="button" class="js-open-filters open-filters" data-type="companies"><?php _e('Companies', 'alven'); ?></button>
                    ...
                    <button type="button" class="js-open-filters open-filters" data-type="location"><?php _e('Location', 'alven'); ?></button>
                    ...
                    <button type="button" class="js-open-filters open-filters" data-type="fields"><?php _e('Fields', 'alven'); ?></button>
                                        ...
                                        <a href='<?php echo '#' . $name; ?>' class='ajax-load' data-name='<?php echo $name; ?>'>
                                            <span class='content-transfered <?php if(!get_field('acquiredBy')){ echo 'no-by'; } ?>'>
                                                ...
                                                <?php if( get_field('acquiredBy') ){ ?>
                                                    <span><?php _e('Sold to', 'alven'); ?></span>
