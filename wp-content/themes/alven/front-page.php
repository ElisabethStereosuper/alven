...
require_once('includes/form-pitch.php');
        ...
        <?php if( have_rows('videos') ) : ?>
            <section class="videos-wrapper">
                ...
                <div class="videos-slider" id="videos">
                    ...
                    <button class="js-video-next video-next-big" type="button" tabindex="-1"><?php _e('Next video', 'alven'); ?></button>
                    <button class="js-video-prev video-prev-big" type="button" tabindex="-1"><?php _e('Previous video', 'alven'); ?></button>
                    ...
                    <div class='posts home-posts'>
                        <?php while ( $queryPost->have_posts() ) : $queryPost->the_post(); ?>
                            <div>
                                ...
                                <?php the_excerpt(); ?>
                                <a href='<?php the_permalink(); ?>' class='btn'><?php _e('Read', 'alven'); ?></a>
                            </div>
                        <?php endwhile; ?>
                    </div>
                    <div class="home-posts-link">
                        <a href="<?php echo get_permalink( get_option( 'page_for_posts' ) ); ?>" class="link"><?php _e('See all', 'alven'); ?></a>
                    </div>
                <?php endif; wp_reset_query(); ?>
            </div>
        </section>

       <section class="contact-wrapper home-contact">
            <div class="container">
